...
# 仕事3/5 74
AlphaItemDef.seed_once(:id,
    { id: 74, dseq:'1', ddescription: 'メンバは自分の意志でタスクを選択し、作業を進めている', alpha_state_def_id: 13, item_level:3, item_point:3 },
    { id: 75, dseq:'2', ddescription: 'チームはタスクのDoneの条件を定義し、それを守ることに同意している', alpha_state_def_id: 13, item_level:2, item_point:3 },
    { id: 76, dseq:'3', ddescription: 'メンバはタスクのDoneの定義に従ってタスクの進捗状況を更新している', alpha_state_def_id: 13, item_level:3, item_point:3 },
    { id: 77, dseq:'4', ddescription: 'メンバはタスクの進捗を適切に更新しており、全員がそれを容易に閲覧できる', alpha_state_def_id: 13, item_level:3, item_point:5 },
    { id: 78, dseq:'5', ddescription: 'ソースが共有されており、定期的に最新版に更新されている', alpha_state_def_id: 13, item_level:3, item_point:5 },
    { id: 79, dseq:'6', ddescription: '共有されたソースを使ってシステムを一定期間ごとに運用環境でビルドしている', alpha_state_def_id: 13, item_level:3, item_point:3 },
    { id: 80, dseq:'7', ddescription: 'バグ情報が共有されており、バグの対策状況が追跡できている', alpha_state_def_id: 13, item_level:3, item_point:3 }
)
...
AlphaItemDef.seed_once(:id,
    ...
    { id: 86, dseq:'6', ddescription: '共有されたソースを使ってシステムを一定期間ごとにビルドできているかを検査している', alpha_state_def_id: 14, item_level:4, item_point:3 },
    { id: 87, dseq:'7', ddescription: 'バグの対策状況が正しく追跡されていることを検査している', alpha_state_def_id: 14, item_level:4, item_point:3 }
)
