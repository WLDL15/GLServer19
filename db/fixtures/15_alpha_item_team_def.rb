...
# チーム2/5 101
AlphaItemDef.seed_once(:id,
    { id: 101, dseq:'1', ddescription: 'メンバ全員が開発を開始している', alpha_state_def_id: 17, item_level:3, item_point:4 },
    { id: 102, dseq:'2', ddescription: 'メンバ全員が定期的に集まる場所と時間を決めている', alpha_state_def_id: 17, item_level:2, item_point:4 },
    { id: 103, dseq:'3', ddescription: '全員がミッションとスケジュールを理解している', alpha_state_def_id: 17, item_level:2, item_point:6 },
    { id: 104, dseq:'4', ddescription: 'チームのコミュニケーションのためのルールを決めている', alpha_state_def_id: 17, item_level:2, item_point:6 },
    { id: 105, dseq:'5', ddescription: '全員がコミュニケーションのルールを守っている', alpha_state_def_id: 17, item_level:2, item_point:3 },
    { id: 106, dseq:'6', ddescription: 'マスタは全員参加する上での障害を理解し、障害を取り除くための支援している', alpha_state_def_id: 17, item_level:3, item_point:2 }
)

# チーム3/5 107
AlphaItemDef.seed_once(:id,
    { id: 107, dseq:'1', ddescription: '情報を共有する上で重視する項目（データの上限、更新間隔、簡便性など）を決定している', alpha_state_def_id: 18, item_level:2, item_point:4 },
    { id: 108, dseq:'2', ddescription: 'チームが情報を共有するための方法（プラクティスやツール）を定義している', alpha_state_def_id: 18, item_level:2, item_point:4 },
    { id: 109, dseq:'3', ddescription: 'チームはメンバの進捗情報を共有している', alpha_state_def_id: 18, item_level:3, item_point:3 },
    { id: 110, dseq:'4', ddescription: 'チームはメンバの障害情報を共有している', alpha_state_def_id: 18, item_level:3, item_point:3 },
    { id: 111, dseq:'5', ddescription: 'チームはメンバの次の計画を共有している', alpha_state_def_id: 18, item_level:3, item_point:6 },
    { id: 112, dseq:'6', ddescription: '決定した共有法が実施され、メンバ全員が互いの状況を理解しているという実感が持てている', alpha_state_def_id: 18, item_level:3, item_point:3 },
    { id: 113, dseq:'7', ddescription: 'マスタは情報共有を促進するための支援をしている', alpha_state_def_id: 18, item_level:3, item_point:6 }
)
...
AlphaItemDef.seed_once(:id,
    ...
    { id: 127, dseq:'6', ddescription: 'チームは開発効率を高めるための方法（プラクティス・ツール）を自らで決定し採用している', alpha_state_def_id: 20, item_level:4, item_point:4 },
    { id: 128, dseq:'7', ddescription: 'マスタは振り返りのプロセスを改善し、高いモチベーションを維持する支援をしている', alpha_state_def_id: 20, item_level:4, item_point:4 }
)