...
AlphaItemDef.seed_once(:id,
    ...
    { id: 121, dseq:'6', ddescription: 'メンバの役割（記録係、チェック係、励まし係など）を決めている', alpha_state_def_id: 16, item_level:2, item_point:5 },

)

# チーム2/5 101
AlphaItemDef.seed_once(:id,
    { id: 122, dseq:'1', ddescription: 'メンバ全員が開発を開始している', alpha_state_def_id: 17, item_level:1, item_point:4 },
    { id: 123, dseq:'2', ddescription: '日次スクラムのために、チーム全員が定期的に集まる場所と時刻を決めている', alpha_state_def_id: 17, item_level:1, item_point:6 },
    { id: 124, dseq:'3', ddescription: 'チームのコミュニケーションのためのツールと利用ルールを決めている', alpha_state_def_id: 17, item_level:2, item_point:3 },
    { id: 125, dseq:'4', ddescription: 'マスタは、メンバが相互に理解を深め、メンバのコミュニケーションを活発にするための支援をしている', alpha_state_def_id: 17, item_level:2, item_point:4 },
    { id: 126, dseq:'5', ddescription: 'マスタは全員参加する上での障害を理解し、障害を取り除くための支援している', alpha_state_def_id: 17, item_level:3, item_point:2 }
)
...
# チーム5/5 121
AlphaItemDef.seed_once(:id,
    { id: 148, dseq:'1', ddescription: 'チームのコミュニケーションを振り返り、その問題点と解決法をまとめている', alpha_state_def_id: 20, item_level:1, item_point:5 },
    { id: 149, dseq:'2', ddescription: 'チームのコミュニケーションのためのツールと利用ルールを振り返り、その問題点と解決法をまとめている', alpha_state_def_id: 20, item_level:2, item_point:4 },
    { id: 150, dseq:'3', ddescription: 'チームの開発状況をメンバ全員で振り返り、/KPT/にまとめている', alpha_state_def_id: 20, item_level:4, item_point:3 },
    { id: 151, dseq:'4', ddescription: '/KPT/のPからＴが提案され、次のスプリントでTがKに改善されている', alpha_state_def_id: 20, item_level:4, item_point:3 },
    { id: 152, dseq:'5', ddescription: 'チームがより効果的・効率的に働くための方法（プラクティス・ツール）を採用している', alpha_state_def_id: 20, item_level:4, item_point:3 },
    { id: 153, dseq:'6', ddescription: 'バグの発生や仕様の変更などの障害にメンバ全員で対応できている', alpha_state_def_id: 20, item_level:4, item_point:4 },
    { id: 154, dseq:'7', ddescription: 'チームの作業負荷が片寄らないように調整ができている', alpha_state_def_id: 20, item_level:4, item_point:3 },
    { id: 155, dseq:'8', ddescription: 'チームは開発効率を高めるための方法（プラクティス・ツール）を自らで決定し採用している', alpha_state_def_id: 20, item_level:4, item_point:4 },
    { id: 156, dseq:'9', ddescription: 'マスタは振り返りのプロセスを改善し、高いモチベーションを維持する支援をしている', alpha_state_def_id: 20, item_level:4, item_point:4 }
)